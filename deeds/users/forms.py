...
class RegistrationForm(FlaskForm):
    ...
    def validate_access_code(self, field):
        correct_code = current_app.config.get('SECRET_ACCESS_CODE', '')
        if field.data != correct_code:
            raise ValidationError('Invalid access code. Please enter the correct code.')
